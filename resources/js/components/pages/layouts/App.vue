    ...
    <div class="box-app">
        <div class="menu-app" :class="[{small : $route.name === 'chat'}]">
            ...
            <ul class="list-unstyled w-100">
                ...
                <router-link
                    class="text-logo text-dark text-decoration-none font-weight-bold"
                    :to="{name : 'home'}">
                    <h1 class="m-0">Diary</h1>
                </router-link>
                ...
                <router-link class="text-dark text-decoration-none" :to="{name : 'chat'}">
                ...
                <router-link
                    ...
                    v-if="getAuth && getAuth.profile">
                    <li class="d-flex" :class="[{active : $route.params.username === getAuth.username}]">
                        <div class="icon">
                            <img :src="getImage(getAuth.profile.image)" class="rounded-circle icon" style="width: 26px;height: 26px;" alt="">
                        </div>
                        <span class="item-text">{{ getAuth.username }}</span>
                    </li>
                </router-link>
            </ul>
        </div>
...
import ModalNewPost from "../../Posts/Modals/ModalNewPost";
import ModalNewMessage from "../../Chat/Modals/ModalNewMessage";
import SearchButton from "../../User/Buttons/SearchButton";
import SearchSlide from "../../User/Slides/SearchSlide";
