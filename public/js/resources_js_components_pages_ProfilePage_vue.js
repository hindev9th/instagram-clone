...
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.esm.js");
/* harmony import */ var _functiton__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../functiton */ "./resources/js/functiton.js");
/* harmony import */ var _Posts_Modals_ModalPostShow__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Posts/Modals/ModalPostShow */ "./resources/js/components/Posts/Modals/ModalPostShow.vue");
/* harmony import */ var _FollowButton__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../FollowButton */ "./resources/js/components/FollowButton.vue");
...
/* harmony import */ var _api_followApi__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../api/followApi */ "./resources/js/api/followApi.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ModalPostShow: _Posts_Modals_ModalPostShow__WEBPACK_IMPORTED_MODULE_1__["default"],
    FollowButton: _FollowButton__WEBPACK_IMPORTED_MODULE_2__["default"],
  ...
  data: function data() {
    return {
      ...
      resource_follows: _api_followApi__WEBPACK_IMPORTED_MODULE_4__.RESOURCE_FOLLOWS
    };
  },
  created: function created() {
    var _this = this;
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapGetters)('profile', ['getProfile', 'getPosts'])), (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapGetters)('auth', ['getAuth'])),
  methods: _objectSpread(_objectSpread(_objectSpread({
    getImage: _functiton__WEBPACK_IMPORTED_MODULE_0__.getImage
  }, (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapActions)('profile', ['fetchProfileAndPosts', "fetchMorePosts"])), (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapActions)('chat', ['getChatId'])), {}, {
    handleRedirectChat: function handleRedirectChat() {
      var _this2 = this;
      this.getChatId([this.getProfile.id]).then(function (id) {
        if (id) {
          _this2.$router.push({
            name: 'message',
            params: {
    ...
    infiniteLoad: function infiniteLoad($state) {
      ...
      setTimeout(function () {
        _this3.page++;
        _this3.fetchMorePosts({
          'username': _this3.$route.params.username,
          'page': _this3.page
        }).then(function () {
          if (_this3.page >= _this3.getPosts.last_page) {
            $state.complete();
          } else {
            $state.loaded();
          }
    ...
    showPost: function showPost(index) {
                                  ...
                                  [
                                    ...
                                    _c(
                                      "button",
                                      {
                                        ...
                                        on: { click: _vm.handleRedirectChat },
                                      },
                                      [
                                        _vm._v(
                                          "\n                                    Message\n                                "
